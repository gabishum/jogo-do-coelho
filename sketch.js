...
function setup() {
    var eCelular = /iPhone|Android|iPod|iPad/i.test(navigator.userAgent);
    if(eCelular == true){
        canW = displayWidth;
        canH = displayHeight;
    }
    ...
    b2.position(width / 2, height / 15);
    b2.size(50, 50);
    b2.mouseClicked(soltar2);
    
    b3 = createImg("cut_btn.png");
    b3.position(width / 3.5, height / 5);
    b3.size(50, 50);
    ...
    corda2 = new Rope(7, { x: width / 2, y: height / 15 });
    corda3 = new Rope(7, { x: width / 3.5, y: height / 5 });
